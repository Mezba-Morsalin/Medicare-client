...
const page = async () => {
    ...
    return (
      ...
      <div className="w-20 h-20 rounded-full bg-sky-100 flex items-center justify-center">
        <FaUserInjured className="text-4xl text-sky-600" />
      </div>
      ...
      <p className="mt-3 max-w-md text-slate-500 leading-relaxed">
        You don ot have any patients assigned yet. Once patients book
        appointments with you, their information will appear here for easy
